    ...
    private sealed class DiscoveryTransport : IAgentRuntimeTransport
    {
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            if (method == AgentRuntimeMethodNames.Initialize)
            {
                ...
                return $"{{\"requestId\":\"{requestId}\",\"ok\":true,\"result\":{{\"ok\":true,\"runtime\":\"fxshell-session-gateway\",\"version\":\"0.1\",\"protocol\":\"fxshell-agent\",\"protocolVersion\":\"1\",\"methods\":[\"initialize\",\"agent/runtime-info\",\"capabilities/check\",\"runtime/cancel\"],\"capabilities\":[\"agent.session.list\"]}}}}";
            }

            if (method == AgentRuntimeMethodNames.RuntimeInfo)
            {
                return $"{{\"requestId\":\"{requestId}\",\"ok\":true,\"result\":{{\"runtime\":\"fxshell-session-gateway\",\"protocol\":\"fxshell-agent\",\"protocolVersion\":\"1\",\"runtimeVersion\":\"0.1\",\"methods\":[\"initialize\"],\"capabilities\":[],\"supportedProtocols\":[]}}}}";
            }
